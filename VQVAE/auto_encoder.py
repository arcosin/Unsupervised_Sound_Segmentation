...
class VQ_VAE(nn.Module):
    ...
    def __init__(self, hidden=200, k=10, vq_coef=0.2, comit_coef=0.4, **kwargs):
        ...
        print(k)
        self.emb_size = k
        self.fc1 = nn.Linear(64000, 1600)
        self.fc2 = nn.Linear(1600, hidden)
        self.fc3 = nn.Linear(hidden, 1600)
        self.fc4 = nn.Linear(1600, 64000)
    ...
    def forward(self, x):
        z_e = self.encode(x.view(-1, 64000))
